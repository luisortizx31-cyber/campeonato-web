...
// /usuarios - ver superadminService.js y la seccion "Colegios" en
// TabConfiguracion.jsx. No es un rol distinto: un superadmin sigue
// siendo 'master' de su propio torneo, y ademas puede crear tenants
// nuevos.
export const ROLES = {
  MASTER: 'master',
}
