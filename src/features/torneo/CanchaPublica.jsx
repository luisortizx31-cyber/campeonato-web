        ...
        <>
          ...
          {(expulsadosLocal.length > 0 || expulsadosVisitante.length > 0) && (
            <div className="mb-3 overflow-hidden rounded-2xl border border-danger/30 bg-danger-soft">
              <p className="border-b border-danger/20 px-3 py-1.5 text-xs font-semibold text-danger">🟥 Expulsados</p>
          ...
          {(amarillasLocal.length > 0 || amarillasVisitante.length > 0) && (
            <div className="mb-3 overflow-hidden rounded-2xl border border-warning/30 bg-warning-soft">
              <p className="border-b border-warning/20 px-3 py-1.5 text-xs font-semibold text-warning">🟨 Amarillas</p>
          ...
          {(goleadoresLocal.length > 0 || goleadoresVisitante.length > 0) && (
            <div className="mb-3 overflow-hidden rounded-2xl border border-brand/30 bg-brand-soft">
              <p className="border-b border-brand/20 px-3 py-1.5 text-xs font-semibold text-brand">⚽ Goleadores</p>
